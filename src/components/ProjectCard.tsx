...
export default function ProjectCard({ project, colorTheme, isAdmin = false, onUpdate }: ProjectCardProps) {
  ...
  return (
    <motion.div
      ...
      className={`relative w-full max-w-2xl holo-glass p-6 md:p-8 rounded-2xl border ${borderClass} transition-shadow duration-500 hover:shadow-2xl overflow-hidden group`}
    >
      ...
      {/* Grid Layout (Text vs. Interactive Graphic) */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col justify-between">
          <div>
            ...
            <div className="flex items-center gap-2 mb-4">
              <span className={`px-2.5 py-1 rounded text-[10px] font-mono tracking-widest uppercase ${bgThemeClass} ${textThemeClass}`}>
                {project.id === 'elam-sahayi' ? 'YIP 8.0 APPROVED' : 'DATABASE SECURED'}
              </span>
              {project.metric && (
                <span 
            ...
            <p 
              ...
              className={`font-display text-sm font-medium mb-4 ${textThemeClass} ${
                isAdmin ? 'outline-dashed outline-1 outline-brand-emerald/40 p-1 rounded bg-brand-emerald/5 hover:outline-brand-emerald cursor-text' : ''
              }`}
            >
              {project.subtitle}
            ...
            {project.architectureDetails && (
              <div className="mb-6">
                <span className="block text-[10px] font-mono tracking-wider text-gray-400 uppercase mb-2">
                  System Architecture
                </span>
          ...
          <div>
            <div className="flex flex-wrap gap-1.5 mb-6">
              {project.tags.map((tag) => (
                <span key={tag} className="px-2 py-0.5 rounded bg-white/[0.03] border border-white/[0.05] text-[10px] font-mono text-gray-400">
                  {tag}
                </span>
              ))}
            </div>
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 text-xs font-mono text-gray-300 hover:text-white transition-colors group/link"
              >
              ...
              {project.liveUrl && project.liveUrl !== '#' && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className={`flex items-center gap-2 text-xs font-mono hover:underline ${textThemeClass}`}
                >
        ...
        {/* Right: Interactive Architectural Schematic SVG Animation */}
        <div className="lg:col-span-5 flex items-center justify-center bg-black/30 rounded-xl p-4 border border-white/[0.03] min-h-[220px]">
          {project.id === 'elam-sahayi' ? (
            ...
            <div className="relative w-full h-full flex flex-col items-center justify-center">
              ...
              <span className="absolute bottom-0 text-[9px] font-mono tracking-widest text-brand-emerald/70 uppercase">
            ...
            <div className="relative w-full h-full flex flex-col items-center justify-center">
              <svg viewBox="0 0 160 160" className="w-36 h-36">
                ...
                <g className="translate-x-[5px] translate-y-[15px] hover:translate-x-[10px] transition-transform duration-300">
                  ...
                  <text x="10" y="39" fill="rgba(255,255,255,0.5)" fontSize="5" fontFamily="monospace">price_hsh (VARCHAR)</text>
                </g>
                ...
                <g className="translate-x-[85px] translate-y-[55px]">
                  ...
                  <text x="10" y="39" fill="rgba(255,255,255,0.5)" fontSize="5" fontFamily="monospace">eta_mins (INT)</text>
                </g>
                ...
                <text x="36" y="127" fill="rgba(255, 255, 255, 0.8)" fontSize="6.5" fontFamily="monospace">SQL SERVER CONNECTED - 3000</text>
              </svg>
              <span className="absolute bottom-0 text-[9px] font-mono tracking-widest text-brand-blue/70 uppercase">
